 ...
 */(function (g, h) {
     ...
     return g.$ === h && (g.$ = c), c.fn = c.prototype = {
         "constructor": c,
         "ready": function (b) {
             return c.bindReady(), c.isReady ? b.call(document, c) : r && r.push(b), this;
         },
         "hasClass": function (b) {
             return -1 < (" " + this[0].className + " ").replace(m, " ").indexOf(" " + b + " ") ? !0 : !1;
         },
         "addClass": function (b) {
             return this.hasClass(b) || (this[0].className += " " + b), this;
         },
         "removeClass": function (b) {
             var d = this[0];
             return b ? this.hasClass(b) && (d.className = d.className.replace(b, " ")) : d.className = "", this;
         },
         "css": function (b, d) {
             var e, a = this[0];
             if ("string" == typeof b) {
         ...
         "html": function (b) {
             var d = this[0];
             return b === h ? d.innerHTML : (c.cleanData(d.getElementsByTagName("*")), d.innerHTML = b, this);
         },
         "remove": function () {
             var b = this[0];
             return c.cleanData(b.getElementsByTagName("*")), c.cleanData([b]), b.parentNode.removeChild(b), this;
         },
         "bind": function (b, d) {
             return c.event.add(this[0], b, d), this;
         },
         "unbind": function (b, d) {
             return c.event.remove(this[0], b, d), this;
         }
     }, c.fn.init = function (b, d) {
         var e, d = d || document;
         return b ? b.nodeType ? (this[0] = b, this) : "body" === b && d.body ? (this[0] = d.body, this) : "head" === b || "html" === b ? (this[0] = d.getElementsByTagName(b)[0], this) : "string" == typeof b && (e = t.exec(b)) && e[2] ? ((e = d.getElementById(e[2])) && e.parentNode && (this[0] = e), this) : "function" == typeof b ? c(document).ready(b) : (this[0] = b, this) : this;
     }, c.fn.init.prototype = c.fn, c.noop = function () { }, c.isWindow = function (b) {
         ...
         if (f === h) {
             for (c in b) if (!1 === d.call(b[c], c, b[c])) break;
         } else for (c = b[0]; a < f && !1 !== d.call(c, a, c) ; c = b[++a]);
         return b;
     }, c.data = function (b, d, e) {
         var a = c.cache, b = n(b);
         return d === h ? a[b] : (a[b] || (a[b] = {}), e !== h && (a[b][d] = e), a[b][d]);
         ...
         "add": function (b, d, e) {
             var i, a, f = c.event;
             a = c.data(b, "@events") || c.data(b, "@events", {}), i = a[d] = a[d] || {}, a = i, (a.listeners = a.listeners || []).push(e), a.handler || (a.elem = b, a.handler = f.handler(a), b.addEventListener ? b.addEventListener(d, a.handler, !1) : b.attachEvent("on" + d, a.handler));
         },
             ...
             if (y) if (d) {
                 if (f = y[d]) {
                     ...
                     if (0 === f.listeners.length) {
                         b.removeEventListener ? b.removeEventListener(d, f.handler, !1) : b.detachEvent("on" + d, f.handler), delete y[d], f = c.data(b, "@events");
                         for (var i in f) w = !1;
         ...
         if (!v) {
             ...
             if (document.addEventListener) document.addEventListener("DOMContentLoaded", s, !1), g.addEventListener("load", c.ready, !1); else if (document.attachEvent) {
                 document.attachEvent("onreadystatechange", s), g.attachEvent("onload", c.ready);
                 var b = !1;
                 try {
         ...
         document.removeEventListener("DOMContentLoaded", s, !1), c.ready();
         ...
         c.fn[e] = function (a) {
             var f = this[0];
             return f ? c.isWindow(f) ? f.document.documentElement["client" + d] || f.document.body["client" + d] : 9 === f.nodeType ? Math.max(f.documentElement["client" + d], f.body["scroll" + d], f.documentElement["scroll" + d], f.body["offset" + d], f.documentElement["offset" + d]) : null : null == a ? null : this;
         };
     }), c.ajax = function (b) {
         ...
         }, d.open("GET", e, 1), d.send(null);
     }, c.fn.animate = function (b, d, e, a) {
         "function" == typeof e && (a = e);
         var e = e && c.easing[e] ? e : "swing", f = this[0], k, w, y, i, j, u, o = {
             "speed": d || 400,
             "easing": e,
             "callback": function () {
                 null != k && (f.style.overflow = ""), a && a();
             },
             "curAnim": {}
         };
         return c.each(b, function (a, f) {
             o.curAnim[a] = f;
         }), c.each(b, function (a, b) {
             w = new c.fx(f, o, a), y = x.exec(b), i = parseFloat("opacity" === a || f.style && null != f.style[a] ? c.css(f, a) : f[a]), j = parseFloat(y[2]), u = y[3];
             if ("height" === a || "width" === a) j = Math.max(0, j), k = [f.style.overflow, f.style.overflowX, f.style.overflowY];
             w.custom(i, j, u);
         }), null != k && (f.style.overflow = "hidden"), this;
     }, c.timers = [], c.fx = function (b, c, e) {
         this.elem = b, this.options = c, this.prop = e;
     }, c.fx.prototype = {
         "custom": function (b, d, e) {
             ...
             var f = this;
             f.startTime = c.fx.now(), f.start = b, f.end = d, f.unit = e, f.now = f.start, f.state = f.pos = 0, a.elem = f.elem, a(), c.timers.push(a), c.timerId || (c.timerId = setInterval(c.fx.tick, 13));
         },
         "step": function () {
             var b = c.fx.now(), d = !0;
             if (b >= this.options.speed + this.startTime) {
                 ...
                 return d && this.options.callback.call(this.elem), !1;
             }
             return b -= this.startTime, this.state = b / this.options.speed, this.pos = c.easing[this.options.easing](this.state, b, 0, 1, this.options.speed), this.now = this.start + (this.end - this.start) * this.pos, this.update(), !0;
         },
         "update": function () {
         ...
         "swing": function (b, c, e, a) {
             return (-Math.cos(b * Math.PI) / 2 + .5) * a + e;
         }
     }, c.fx.tick = function () {
     ...
     var q = h.VBArray && !h.XMLHttpRequest, z = "createTouch" in document && !("onmousemove" in v) || /(iPhone|iPad|iPod)/i.test(navigator.userAgent), x = "artDialog" + +(new Date), b = function (a, f, c) {
         ...
         return g.each({
             ...
             a[f] = a[f] !== n ? a[f] : a[b];
         }), "string" == typeof e && (e = g(e)[0]), a.id = e && e[x + "follow"] || a.id || x + s, d = b.list[a.id], e && d ? d.follow(e).zIndex().focus() : d ? d.zIndex().focus() : (z && (a.fixed = !1), g.isArray(a.button) || (a.button = a.button ? [a.button] : []), f !== n && (a.ok = f), c !== n && (a.cancel = c), a.ok && a.button.push({
             "name": a.okVal,
             "callback": a.ok,
             "focus": !0
     ...
     b.fn = b.prototype = {
         ...
         "content": function (a, b) {
             ...
             return j._elemBack && j._elemBack(), o.style.width = "auto", a === n ? l : ("string" == typeof a ? u.html(a) : a && 1 === a.nodeType && (i = a.style.display, c = a.previousSibling, d = a.nextSibling, e = a.parentNode, j._elemBack = function () {
                 c && c.parentNode ? c.parentNode.insertBefore(a, c.nextSibling) : d && d.parentNode ? d.parentNode.insertBefore(a, d) : e && e.appendChild(a), a.style.display = i, j._elemBack = null;
             }, u.html(""), l.appendChild(a), a.style.display = "block"), b || (j.config.follow ? j.follow(j.config.follow) : (g = o.offsetWidth - g, t = o.offsetHeight - t, q -= t / 2, o.style.left = Math.max(h - g / 2, 0) + "px", o.style.top = Math.max(q, 0) + "px"), m && "auto" !== m && (o.style.width = o.offsetWidth + "px"), j._autoPositionType()), j._ie6SelectFix(), j._runScript(l), j);
         },
         "title": function (a) {
         ...
         "position": function (a, b) {
             ...
             if (a || 0 === a) (this._left = -1 !== a.toString().indexOf("%") ? a : null, a = this._toNumber(a, o - m), "number" == typeof a) ? (a = c ? a += i : a + g, d.left = Math.max(a, g) + "px") : "string" == typeof a && (d.left = a);
             if (b || 0 === b) (this._top = -1 !== b.toString().indexOf("%") ? b : null, b = this._toNumber(b, h - p), "number" == typeof b) ? (b = c ? b += j : b + e, d.top = Math.max(b, e) + "px") : "string" == typeof b && (d.top = b);
             return a !== n && b !== n && (this._follow = null, this._autoPositionType()), this;
         },
         "size": function (a, b) {
             var c, d, e = this.DOM;
             d = e.wrap;
             var i = e.main, g = d[0].style, e = i[0].style;
             return a && ((this._width = -1 !== a.toString().indexOf("%") ? a : null, c = l.width() - d[0].offsetWidth + i[0].offsetWidth, a = c = this._toNumber(a, c), "number" == typeof a) ? (g.width = "auto", e.width = Math.max(this.config.minWidth, a) + "px", g.width = d[0].offsetWidth + "px") : "string" == typeof a && (e.width = a, "auto" === a && d.css("width", "auto"))), b && ((this._height = -1 !== b.toString().indexOf("%") ? b : null, d = l.height() - d[0].offsetHeight + i[0].offsetHeight, b = d = this._toNumber(b, d), "number" == typeof b) ? e.height = Math.max(this.config.minHeight, b) + "px" : "string" == typeof b && (e.height = b)), this._ie6SelectFix(), this;
         },
         "follow": function (a) {
             var b, c = this.config;
             ...
             return p.left = (s < j ? m : s + r > e && m - r > j ? m - r + b : s) + "px", p.top = (z + n > i + u && o - n > u ? o - n : z) + "px", this._follow && this._follow.removeAttribute(d), this._follow = a, a[d] = c.id, this._autoPositionType(), this;
         },
         "button": function () {
             var a = this, b = arguments, c = a.DOM.buttons, d = c[0], e = a._listeners = a._listeners || {}, i = g.isArray(b[0]) ? b[0] : [].slice.call(b);
             return b[0] === n ? d : (g.each(i, function (b, c) {
                 var f = c.name, k = !e[f], i = k ? document.createElement("button") : e[f].elem;
                 e[f] || (e[f] = {}), c.callback && (e[f].callback = c.callback), c.className && (i.className = c.className), c.focus && (a._focus && a._focus.removeClass("aui_state_highlight"), a._focus = g(i).addClass("aui_state_highlight"), a.focus()), i.setAttribute("type", "button"), i[x + "callback"] = f, i.disabled = !!c.disabled, k && (i.innerHTML = f, e[f].elem = i, d.appendChild(i));
             }), c[0].style.display = i.length ? "" : "none", a._ie6SelectFix(), a);
         },
         "show": function (a) {
             return this.DOM.wrap.show(), !a && this._lockMaskWrap && this._lockMaskWrap.show(), this;
         },
         "hide": function (a) {
             return this.DOM.wrap.hide(), !a && this._lockMaskWrap && this._lockMaskWrap.hide(), this;
         },
         "close": function () {
             ...
             this.unlock(), this._elemBack && this._elemBack(), c[0].className = c[0].style.cssText = "", a.title.html(""), a.content.html(""), a.buttons.html(""), b.focus === this && (b.focus = null), g && g.removeAttribute(x + "follow"), delete d[this.config.id], this._removeEvent(), this.hide(!0)._setAbsolute();
             for (var i in this) this.hasOwnProperty(i) && "DOM" !== i && delete this[i];
             return p ? c.remove() : p = this, this;
         },
         "time": function (a) {
             var b = this, c = b.config.cancelVal, d = b._timer;
             return d && clearTimeout(d), a && (b._timer = setTimeout(function () {
                 b._click(c);
             }, 1e3 * a)), b;
         },
         "focus": function () {
         ...
         "zIndex": function () {
             ...
             return a.css("zIndex", d), this._lockMask && this._lockMask.css("zIndex", d - 1), c && c.DOM.wrap.removeClass("aui_state_focus"), b.focus = this, a.addClass("aui_state_focus"), this;
         },
         "lock": function () {
             ...
             return a.zIndex(), d.addClass("aui_state_lock"), j[0].style.cssText = h + ";position:fixed;z-index:" + c + ";top:0;left:0;overflow:hidden;" + i, m[0].style.cssText = "height:100%;background:" + e.background + ";filter:alpha(opacity=0);opacity:0", q && m.html('<iframe src="about:blank" style="width:100%;height:100%;position:absolute;top:0;left:0;z-index:-1;filter:alpha(opacity=0)"></iframe>'), m.stop(), m.bind("click", function () {
                 a._reset();
                 ...
                 "opacity": e.opacity
             }, e.duration), a._lockMaskWrap = j, a._lockMask = m, a._lock = !0, a;
         },
         "unlock": function () {
             var a = this._lockMaskWrap, b = this._lockMask;
             if (!this._lock) return this;
             var c = a[0].style, d = function () {
                 q && (c.removeExpression("width"), c.removeExpression("height"), c.removeExpression("left"), c.removeExpression("top")), c.cssText = "display:none", p && a.remove();
             };
             return b.stop().unbind(), this.DOM.wrap.removeClass("aui_state_lock"), this.config.duration ? b.animate({
                 "opacity": 0
             }, this.config.duration, d) : d(), this._lock = !1, this;
         },
         "_getDOM": function () {
             var a = document.createElement("div"), c = document.body;
             a.style.cssText = "position:absolute;left:0;top:0", a.innerHTML = b._templates, c.insertBefore(a, c.firstChild);
             for (var c = 0, d = {
                 "wrap": g(a)
         ...
         "_toNumber": function (a, b) {
             ...
             var c = a.length - 1;
             return a.lastIndexOf("px") === c ? a = parseInt(a) : a.lastIndexOf("%") === c && (a = parseInt(b * a.split("%")[0] / 100)), a;
         },
         ...
         "_runScript": function (a) {
             for (var b, c = b = 0, a = a.getElementsByTagName("script"), d = a.length, e = []; b < d; b++) "text/dialog" === a[b].type && (e[c] = a[b].innerHTML, c++);
         ...
         "_setFixed": function () {
             return q && g(function () {
                 ...
                 if (q) {
                     ...
                     this._setAbsolute(), b.setExpression("left", "eval((document.documentElement).scrollLeft + " + (c - d) + ') + "px"'), b.setExpression("top", "eval((document.documentElement).scrollTop + " + (a - e) + ') + "px"');
                 } else b.position = "fixed";
             };
         }(),
         "_setAbsolute": function () {
             var a = this.DOM.wrap[0].style;
             q && (a.removeExpression("left"), a.removeExpression("top")), a.position = "absolute";
         },
         "_click": function (a) {
             return a = this._listeners[a] && this._listeners[a].callback, "function" != typeof a || !1 !== a.call(this, h) ? this.close() : this;
         },
         "_reset": function (a) {
             ...
             (d || e) && this.size(d, e), c ? this.follow(c) : (i || g) && this.position(i, g);
         },
         "_addEvent": function () {
             ...
             }, l.bind("resize", b._winResize), e.wrap.bind("click", function (a) {
                 a = a.target;
                 if (a.disabled) return !1;
                 if (a === e.close[0]) return b._click(c.cancelVal), !1;
                 (a = a[x + "callback"]) && b._click(a), b._ie6SelectFix();
     ...
     }, b.fn._init.prototype = b.fn, g.fn.dialog = g.fn.artDialog = function () {
         var a = arguments;
         return this[this.live ? "live" : "bind"]("click", function () {
             return b.apply(this, a), !1;
         }), this;
     }, b.focus = null, b.get = function (a) {
         return a === n ? b.list : b.list[a];
     }, b.list = {}, t.bind("keydown", function (a) {
         ...
         return c = d || a[a.length - 1], d = c.src.replace(/\\/g, "/"), 0 > d.lastIndexOf("/") ? "." : d.substring(0, d.lastIndexOf("/"));
     }(document.getElementsByTagName("script"));
     if (v = c.src.split("skin=")[1]) {
         var d = document.createElement("link");
         d.rel = "stylesheet", d.href = r + "/skins/" + v + ".css?" + b.fn.version, c.parentNode.insertBefore(d, c);
     }
     ...
     b._templates = '<div class="aui_outer"><table class="aui_border"><tbody><tr><td class="aui_nw"></td><td class="aui_n"></td><td class="aui_ne"></td></tr><tr><td class="aui_w"></td><td class="aui_c"><div class="aui_inner"><table class="aui_dialog"><tbody><tr><td colspan="2" class="aui_header"><div class="aui_titleBar"><div class="aui_title"></div><a class="aui_close" href="javascript:/*artDialog*/;">\xd7</a></div></td></tr><tr><td class="aui_icon"><div class="aui_iconBg"></div></td><td class="aui_main"><div class="aui_content"></div></td></tr><tr><td colspan="2" class="aui_footer"><div class="aui_info"></div><div class="aui_buttons"></div></td></tr></tbody></table></div></td><td class="aui_e"></td></tr><tr><td class="aui_sw"></td><td class="aui_s"></td><td class="aui_se"></td></tr></tbody></table></div>', b.defaults = {
 ...
 }(this.art || this.jQuery && (this.art = jQuery), this), function (g) {
     ...
     artDialog.dragEvent = function () {
         ...
         "onstart": g.noop,
         "start": function (g) {
             return c.bind("mousemove", this.move).bind("mouseup", this.end), this._sClientX = g.clientX, this._sClientY = g.clientY, this.onstart(g.clientX, g.clientY), !1;
         },
         "onmove": g.noop,
         "move": function (c) {
             return this._mClientX = c.clientX, this._mClientY = c.clientY, this.onmove(c.clientX - this._sClientX, c.clientY - this._sClientY), !1;
         },
         "onend": g.noop,
         "end": function (g) {
             return c.unbind("mousemove", this.move).unbind("mouseup", this.end), this.onend(g.clientX, g.clientY), !1;
         }
     }, n = function (g) {
         ...
         h.onstart = function () {
             d ? (q = w[0].offsetWidth, n = w[0].offsetHeight) : (x = f[0].offsetLeft, b = f[0].offsetTop), c.bind("dblclick", h.end), !r && s ? k.bind("losecapture", h.end) : p.bind("blur", h.end), l && k[0].setCapture(), f.addClass("aui_state_drag"), e.focus();
         }, h.onmove = function (a, c) {
             if (d) {
                 var g = f[0].style, h = w[0].style, k = a + q, l = c + n;
                 g.width = "auto", h.width = Math.max(0, k) + "px", g.width = f[0].offsetWidth + "px", h.height = Math.max(0, l) + "px";
             } else h = f[0].style, g = Math.max(m.minX, Math.min(m.maxX, a + x)), k = Math.max(m.minY, Math.min(m.maxY, c + b)), h.left = g + "px", h.top = k + "px";
             v(), e._ie6SelectFix();
         }, h.onend = function () {
             c.unbind("dblclick", h.end), !r && s ? k.unbind("losecapture", h.end) : p.unbind("blur", h.end), l && k[0].releaseCapture(), r && !e.closed && e._autoPositionType(), f.removeClass("aui_state_drag");
         }, d = g.target === a.se[0] ? !0 : !1, m = function () {
