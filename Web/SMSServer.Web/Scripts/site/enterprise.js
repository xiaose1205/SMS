    ...
    if ($("#grid") != undefined) {
        gird = $("#grid").flexigrid({
            ...
            colModel: [
                ...
                { display: '短信单价', name: 'smsprice', width: 150, align: 'center' },
                 { display: '移动通道', name: 'chinamobile', width: 150, align: 'center' },
                  { display: '联通通道', name: 'union', width: 150, align: 'center' },
                  { display: '电信通道', name: 'cdma', width: 150, align: 'center' },
