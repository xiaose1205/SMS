...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <div class="sendpanel">
        ...
        <div class="pleft formPanel">
            <h4>待发送联系人列表</h4>
            <textarea style="width: 240px; height: 240px;" id="waitsenduser"></textarea>
            <div class="cont_tools" style="width:100%">

              可以在输入框内直接粘贴(,分隔)  <a href="#" class="button button-rounded button-tiny   button-highlight">清空</a>
            </div>
        </div>
              ...
              <h4>编辑短信信息</h4>
                ...
                <div style="padding-bottom: 5px; padding-top: 5px">
                    <div style="margin-bottom: 5px;">
                        批次名称：
                    <input class="text" maxlength="50" style="width: 60%; min-width: 330px;" id="txtName" />
                    </div>
                    <div>
                        批次备注：
